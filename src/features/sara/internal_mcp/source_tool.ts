...
export async function getSaraSourceTool(project_id: string): Promise<InternalMcpToolResult<SourceData>> {
    ...
    return {
        tool_name: "get_source_intelligence",
